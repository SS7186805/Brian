...
class ChallengesViewModelFactory(
    private val challengesRepository: ChallengesRepository, private val profileRepository: MyProfileRepository,private val resourcesProvider: ResourcesProvider
) :
    ViewModelProvider.NewInstanceFactory() {
    @Suppress("UNCHECKED_CAST")
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        return ChallengesViewModel(challengesRepository,profileRepository,resourcesProvider) as T
    }
}