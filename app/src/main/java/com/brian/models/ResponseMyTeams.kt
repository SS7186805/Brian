...
data class ResponseMyTeams(

	@field:SerializedName("result")
	val result: String? = null,

	@field:SerializedName("data")
	val data: DataMyTeam? = null,
...
data class DataMyTeam(
	...
	@field:SerializedName("data")
	val data: ArrayList<DataItemMyTeam>? = null,
...
data class DataItemMyTeam(
	...
	val teamMembers: ArrayList<MyTeamMembersItem>? = null,
...
data class MyTeamMembersItem(
	...
	val user: MyTeamUser? = null
):Parcelable

@Parcelize
data class MyTeamUser(
